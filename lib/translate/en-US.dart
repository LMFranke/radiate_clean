  ...
  String getTranslate(Texts text) {
    switch (text) {
      ...
      case Texts.value_all_day:
        return "Full-day Value";

      case Texts.value_half_day:
        return "Half-day Value";
      ...
      case Texts.error_to_load_clients:
        return "Error while load clients";

      case Texts.error_to_load_services:
        return "Error while load services";

      case Texts.info:
        return "Info";

      case Texts.select_client:
        return "Select an client";
      ...
      case Texts.cancel_event_message:
        return "Are you sure you want to cancel this event?";
